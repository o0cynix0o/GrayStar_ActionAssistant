# GS Book 2 Pass 1 Rules Baseline

Book: The Forbidden City
Generated: 2026-05-20T14:56:37

## Source Baseline

- Primary local source: `books/gs/02tfc/`
- Numbered sections found: 310 / 310
- Supporting pages reviewed locally: `gamerulz.htm`, `equipmnt.htm`, `cmbtrulz.htm`, `footnotz.htm`, `powers.htm`, `sage.htm`, `errata.htm`
- Generated source inventory: `testing/tmp/gsbook2_source_inventory.json`
- Generated keyword sweep: `testing/tmp/gsbook2_source_sweep.json`

## Book 2 Rule Notes Applied
...
- Reachable sections from section 1: 310 / 310
- Terminal death/failure sections: 26
- Implemented simple automation sections: 130
- Implemented flow sections: 42
- Detected combat sections: 18
- Detected random-roll sections: 9
